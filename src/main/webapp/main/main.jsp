                                  ...
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          ...
                                          <div class="media-body">
                                              <h5 class="notification-user">Edan Almeida</h5>
                          ...
                          <div class="">
                              <div class="main-menu-header">
                                  ...
                                  <div class="user-details">
                                      <span id="more-details">Edan Almeida<i class="fa fa-caret-down"></i></span>
                                  </div>
                              </div>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="d-inline-block align-middle">
                                                                            ...
                                                                            <div class="d-inline-block">
                                                                                <h6>Edan Almeida</h6>
                                                                                <p class="text-muted m-b-0">Picudo Demais</p>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td>Able Pro</td>
